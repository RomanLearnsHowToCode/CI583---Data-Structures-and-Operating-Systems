...
public class TestHT {
	...
	public void testInsert() {
		Hashtable<Boolean> h = new Hashtable<Boolean>(1000, PROBE_TYPE.DOUBLE_HASH); // DOUBLE_HASH
		for(int i=0;i<2000;i++) { // xx 2000
			for(int j=2000;j>0;j--) { // xx 2000
				h.put(i+":"+j, true);

			}
		}

		for(int i=0;i<2000;i++) { // x 2000
			for(int j=2000;j>0;j--) { // x 2000
